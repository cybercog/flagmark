...
<noscript><div><img src="https://mc.yandex.ru/watch/<?= getenv('YANDEX_METRIKA_ID') ?>" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
    ...
    <?php if (isLoggedIn()) : ?>
        ...
        <div class="actions">
            <a href="<?= $imageUrl ?>" class="btn btn-primary-outline" onclick="saveImageAs('<?= $imageUrl ?>'); yaCounter<?= getenv('YANDEX_METRIKA_ID') ?>.reachGoal('download'); return true;">Download it!</a>
        </div>
